<template>
  <div>
    <div class="bmap-example-toolbar">
      <button class="bmap-example-button" :disabled="isLoading" @click="run">规划驾车路线</button>
    ...
    <Map v-bind="$attrs" :zoom="12" :center="from">
...
const { data, status, sdkStatus, isLoading, isEmpty, search, clear } = useDrivingRoute({
  location: "北京市",
});
