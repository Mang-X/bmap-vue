# vue3-baidu-map-gl 变更记录（历史）

本页是 [yue1123/vue3-baidu-map-gl](https://github.com/yue1123/vue3-baidu-map-gl)
的原始变更记录，**原样保留**作为来源记录——它是 `bmap-vue` 的前身。

> 本项目当前是 `bmap-vue@1.0`（见[项目来源与致谢](../zh-CN/about.md)）。
> 下面这份历史里的版本号、组件名与 SDK 版本属于 `vue3-baidu-map-gl`，
> **不是** `bmap-vue` 的契约。特别注意：上游也有一个 `1.0.0`（2022-11-22），
> 与 `bmap-vue@1.0` 无关。
...
* `LuShu` 插件默认地址 undefined ([7a123ea](https://github.com/yue1123/vue3-baidu-map-gl/commit/7a123eac208e9dc12a6d04cd43a6eb36a800fbab)), closes [#118](https://github.com/yue1123/vue3-baidu-map-gl/issues/118)
