 ...
 * | 真实 v4 Tile/Traffic/GeoJSON smoke | 不在本文件：`tests/browser/jsapi-v4/**` 的 `layer-tile` / `layer-traffic` / `layer-geojson`（fixture 档进 PR 门禁，live 档 nightly） | 见 `v4-smoke-workflow.test.ts` |
 ...
 *
 * 与 `component-scenarios.test.ts` 里的同名探针同源（那条路走 `useRequiredMapContext`
 * 读上下文的事件总线）。
 */
