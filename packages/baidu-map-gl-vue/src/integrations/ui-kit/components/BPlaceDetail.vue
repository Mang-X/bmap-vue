...
/**
 * BPlaceDetail —— 官方 UI Kit `PlaceDetail` 的 Vue 薄封装（UIKIT-02 / issue #75）
 *
...
export interface BPlaceDetailProps {
...
const props = withDefaults(defineProps<BPlaceDetailProps>(), {});
...
const CONSTRUCTOR_OPTION_KEYS = ["display"] as const satisfies readonly (keyof BPlaceDetailProps)[];
...
defineOptions({ name: "BPlaceDetail" });
</script>
