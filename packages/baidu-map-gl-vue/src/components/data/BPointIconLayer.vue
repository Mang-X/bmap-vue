...
function ctorOptions(p: Readonly<BPointIconLayerProps<Item>>): Record<string, unknown> {
  return {
...
const resource = useNativeLayerResource<BPointIconLayerProps<Item>>(props, {
  component: LABEL,
  kind: LAYER_KIND,
  ctorOptions,
