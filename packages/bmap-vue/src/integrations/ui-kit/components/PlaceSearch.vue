...
/**
 * PlaceSearch —— 官方 UI Kit `PlaceSearch` 的 Vue 薄封装（R25-D / issue #73）
 *
...
const props = withDefaults(defineProps<PlaceSearchProps>(), {});
...
const CONSTRUCTOR_OPTION_KEYS = [
  ...
  "pageNum",
  "display",
] as const satisfies readonly (keyof PlaceSearchProps)[];
