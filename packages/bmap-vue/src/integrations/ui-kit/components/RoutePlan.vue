...
/**
 * RoutePlan —— 官方 UI Kit `RoutePlan` 的 Vue 薄封装（UIKIT-02 / issue #75）
 *
...
const props = withDefaults(defineProps<RoutePlanProps>(), {});
...
const CONSTRUCTOR_OPTION_KEYS = [
  "drivingOptions",
] as const satisfies readonly (keyof RoutePlanProps)[];
