...
/**
 * DOMLayer —— 自定义 DOM 覆盖物图层（官方 `BMap.DOMLayer`，4.0）
 *
...
const props = withDefaults(defineProps<DOMLayerProps>(), {
...
useLayerResource<DOMLayerProps>(props, {
  component: "DOMLayer",
  toSpec: (p) => ({
    kind: "dom",
    visible: p.visible,
